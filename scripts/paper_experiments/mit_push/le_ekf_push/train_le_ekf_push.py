...
from dynamics_learning.networks.kalman.le_ekf import LinearEnsembleEKFEstimatorConfig
...
hyperparameter_defaults = dict(
    batch_size=16, learning_rate=5e-3, epochs=400, latent_dim=8
)
...
model_config = LinearEnsembleEKFEstimatorConfig(
    is_smooth=True,
